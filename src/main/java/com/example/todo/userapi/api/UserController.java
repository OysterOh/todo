...
public class UserController {
    ...
    public ResponseEntity<?> loadFile(
        ...
        try {
            ...
            MediaType contentType = findExtenstionAndGetMediaType(filePath);
            if (contentType == null) {
    ...
    private MediaType findExtenstionAndGetMediaType(String filePath) {

        //파일 경로에서 확장자 추출하기
        //C://todo_upload/lkjoijslsasquiofhqabu.jpg
    ...
    // S3에서 불러온 프로필 사진 처리
    @GetMapping("/load-s3")
    public ResponseEntity<?> loadS3(@AuthenticationPrincipal TokenUserInfo userInfo
    ) {
